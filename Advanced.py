...
print("Show the relationship between the columns :- ")
adv_data = pd.read_csv('data.csv')
print(adv_data.corr()) #The corr() method ignores "not numeric" columns.

#Output Analysis for above code :-
# Perfect Correlation:
...
# which is a very bad correlation, 
# meaning that we can not predict the max pulse by just looking at the duration of the work out, 
# and vice versa.
